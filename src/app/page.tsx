              ...
              <tbody>
                {automations.map((a) => (
                  <tr key={a.id}>
                    ...
                    <td className="muted">{[a.triggers.includes("story_reply") && "stories", a.triggers.includes("story_mention") && "mentions", a.triggers.includes("dm") && "DMs", a.requireOptIn && "opt-in", a.requireFollow && "follow gate", a.collectEmail && "email", a.intentDescription && "intent", a.aiFaq && "FAQ", a.dmButtonTitle && "button"].filter(Boolean).join(" · ") || "—"}</td>
